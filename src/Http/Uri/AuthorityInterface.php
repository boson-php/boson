...
interface AuthorityInterface extends StringValueObjectInterface
{
     ...
     */
    public const string HOST_PORT_DELIMITER = ':';

    /**
     * @var non-empty-string
     */
    public const string USER_INFO_DELIMITER = '@';
     ...
     * For example, the {@see Scheme::Http} scheme defines a default port
     * of '80', corresponding to its reserved `TCP` port number. The type of
